...
func (m *MockDeviceRepository) ValidateDevice(serialNumber, secret string) (*entities.Device, error) {
...
func (m *MockDeviceRepository) Create(ctx context.Context, device *entities.Device) error {
	m.devices[device.ID] = device
	return nil
}

func (m *MockDeviceRepository) GetByID(ctx context.Context, id string) (*entities.Device, error) {
...
func (m *MockDeviceRepository) GetBySerialNumber(ctx context.Context, serialNumber string) (*entities.Device, error) {
	for _, device := range m.devices {
		if device.SerialNumber == serialNumber {
			return device, nil
		}
...
func (m *MockDeviceRepository) GetByOwnerID(ctx context.Context, ownerID string) ([]*entities.Device, error) {
